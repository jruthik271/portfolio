...
export default function AboutHome() {
  const techStack = [
    'Dart', 'Flutter', 'Python', 'JavaScript', 'C', 
    'Node.js', 'Express.js', 'Firebase', 'MongoDB', 'MySQL', 'Git', 'Postman'
  ];
  ...
  useEffect(() => {
    const fetchLiveStats = async () => {
      try {
        ...
        console.warn('Failed to fetch dynamic stats for AboutHome:', err);
      } finally {
        setLoading(false);
      }
    };
          ...
          <div className="w-full lg:w-[45%] flex justify-center relative">
            ...
            >
              <div className="relative aspect-[3/4] w-full rounded-[24px] overflow-hidden bg-background border border-border flex items-center justify-center">
                <img
                  src={`${import.meta.env.BASE_URL}img2.jpeg`}
                  onError={(e) => {
          ...
          <div className="w-full lg:w-[55%] text-left flex flex-col items-start">
            ...
            >
              ...
              <p className="text-foreground/60 text-base sm:text-lg leading-relaxed mb-8 font-medium">
                I'm an <strong className="text-[var(--color-accent)] font-black">AI/ML Undergraduate</strong> & Full-Stack Mobile App Developer passionate about building digital products that make a difference. From building roadside assistance apps to deploying scaling APIs, I enjoy turning complex algorithms into elegant, user-centric mobile applications using Flutter and modern tech stacks.
              </p>
